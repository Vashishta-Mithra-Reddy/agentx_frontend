...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen min-w-screen flex items-center justify-center font-outfit md:bg-foreground/5 dark:bg-background">
      <motion.div initial={{y:10,opacity: 0,filter:"blur(5px)"}} animate={{y:0,opacity: 1,filter:"blur(0px)"}} exit={{y:10,opacity: 0,filter:"blur(5px)"}} transition={{duration: 0.5,ease:"easeInOut"}} className="px-12 pt-12 pb-6 rounded-xl w-full max-w-md bg-background">
        <h2 className="text-3xl mb-12 text-center">Login to <Link href="/" className="font-semibold">AgentX</Link></h2>
